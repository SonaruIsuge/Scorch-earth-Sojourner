...
public partial class @InputControl: IInputActionCollection2, IDisposable
{
    ...
    private List<IAlbumBookActions> m_AlbumBookActionsCallbackInterfaces = new List<IAlbumBookActions>();
    ...
    public struct AlbumBookActions
    {
        ...
        public void AddCallbacks(IAlbumBookActions instance)
        {
            if (instance == null || m_Wrapper.m_AlbumBookActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_AlbumBookActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IAlbumBookActions instance)
        {
            @Up.started -= instance.OnUp;
            @Up.performed -= instance.OnUp;
            @Up.canceled -= instance.OnUp;
        ...
        public void RemoveCallbacks(IAlbumBookActions instance)
        {
            if (m_Wrapper.m_AlbumBookActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IAlbumBookActions instance)
        {
            foreach (var item in m_Wrapper.m_AlbumBookActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_AlbumBookActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<IMemoryCameraActions> m_MemoryCameraActionsCallbackInterfaces = new List<IMemoryCameraActions>();
    ...
    public struct MemoryCameraActions
    {
        ...
        public void AddCallbacks(IMemoryCameraActions instance)
        {
            if (instance == null || m_Wrapper.m_MemoryCameraActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_MemoryCameraActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IMemoryCameraActions instance)
        {
            @ControlPictureArea.started -= instance.OnControlPictureArea;
            @ControlPictureArea.performed -= instance.OnControlPictureArea;
            @ControlPictureArea.canceled -= instance.OnControlPictureArea;
        ...
        public void RemoveCallbacks(IMemoryCameraActions instance)
        {
            if (m_Wrapper.m_MemoryCameraActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IMemoryCameraActions instance)
        {
            foreach (var item in m_Wrapper.m_MemoryCameraActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_MemoryCameraActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
